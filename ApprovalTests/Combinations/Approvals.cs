...
namespace ApprovalTests.Combinations
{
	public class Approvals
	{
		...
		public static void ApproveAllCombinations<A>(Func<A, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a), "[{0}]", resultFormatter, aList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
		}
		...
		public static void ApproveAllCombinations<A, B>(Func<A, B, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList, IEnumerable<B> bList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a, b), "[{0},{1}]", resultFormatter, aList, bList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
		}
		...
		public static void ApproveAllCombinations<A, B, C>(Func<A, B, C, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList, IEnumerable<B> bList, IEnumerable<C> cList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a, b, c), "[{0},{1},{2}]", resultFormatter, aList, bList, cList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
		}
		...
		public static void ApproveAllCombinations<A, B, C, D>(Func<A, B, C, D, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList, IEnumerable<B> bList, IEnumerable<C> cList, IEnumerable<D> dList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a, b, c, d), "[{0},{1},{2},{3}]", resultFormatter, aList, bList, cList, dList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
		}
		...
		public static void ApproveAllCombinations<A, B, C, D, E>(Func<A, B, C, D, E, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList, IEnumerable<B> bList, IEnumerable<C> cList, IEnumerable<D> dList, IEnumerable<E> eList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a, b, c, d, e), "[{0},{1},{2},{3},{4}]", resultFormatter, aList, bList, cList, dList, eList, EMPTY, EMPTY, EMPTY, EMPTY);
		}
		...
		public static void ApproveAllCombinations<A, B, C, D, E, F>(Func<A, B, C, D, E, F, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList, IEnumerable<B> bList, IEnumerable<C> cList, IEnumerable<D> dList, IEnumerable<E> eList, IEnumerable<F> fList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a, b, c, d, e, f), "[{0},{1},{2},{3},{4},{5}]", resultFormatter, aList, bList, cList, dList, eList, fList, EMPTY, EMPTY, EMPTY);
		}
		...
		public static void ApproveAllCombinations<A, B, C, D, E, F, G>(Func<A, B, C, D, E, F, G, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList, IEnumerable<B> bList, IEnumerable<C> cList, IEnumerable<D> dList, IEnumerable<E> eList, IEnumerable<F> fList, IEnumerable<G> gList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a, b, c, d, e, f, g), "[{0},{1},{2},{3},{4},{5},{6}]", resultFormatter, aList, bList, cList, dList, eList, fList, gList, EMPTY, EMPTY);
		}
		...
		public static void ApproveAllCombinations<A, B, C, D, E, F, G, H>(Func<A, B, C, D, E, F, G, H, object> processCall, Func<object, string> resultFormatter, IEnumerable<A> aList, IEnumerable<B> bList, IEnumerable<C> cList, IEnumerable<D> dList, IEnumerable<E> eList, IEnumerable<F> fList, IEnumerable<G> gList, IEnumerable<H> hList)
		{
			ApproveAllCombinations((a, b, c, d, e, f, g, h, i) => processCall(a, b, c, d, e, f, g, h), "[{0},{1},{2},{3},{4},{5},{6},{7}]", resultFormatter, aList, bList, cList, dList, eList, fList, gList, hList, EMPTY);
		}
		...
		{
			ApproveAllCombinations(processCall, "[{0},{1},{2},{3},{4},{5},{6},{7},{8}]", resultFormatter, aList, bList, cList, dList, eList, fList, gList, hList, iList);
		}
		...
		{
			ApproveAllCombinations(processCall, format, (result) => result + string.Empty, aList, bList, cList, dList, eList, fList, gList, hList, iList);
		}
